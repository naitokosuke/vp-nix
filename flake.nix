      ...
      mkVitePlus =
        ...
        let
          ...
          src = pkgs.fetchFromGitHub {
            ...
            repo = "vite-plus";
            rev = "v${version}";
            hash = "sha256-1Zjfp8YFu2AJwhU7QUjOQ1y06LOw24lXzXOI84wYwyY=";
          };
          ...
          vitePlusNodeModules = pkgs.stdenv.mkDerivation {
            ...
            pnpmDeps = pkgs.fetchPnpmDeps {
              ...
              inherit version;
              src = ./pnpm;
              hash = "sha256-AGU02bswLIQvf5ma98ljgdvDsKsM1Dt27v81HuAZCgk="; # pnpmDepsHash
              fetcherVersion = 3;
            };
          ...
          cargoVendorDir = pkgs.stdenv.mkDerivation {
            ...
            outputHash = "sha256-czocI7c++NKLnrOHb5t0GP80e5w7Zuz4brC6miHR5yI="; # cargoVendorHash
          };
